...
The exercise was fun, but I have to say that the API was quite problematic, especially with regards to the varying amounts of data sent with each call, the amount of modelling required and the team's logos in SVG format, which proved to be more problematic in Swift than I anticipated.
I wish I had more time to add more functionality such as search, favourite team, more information in the team view and to add some more fluff in general.
